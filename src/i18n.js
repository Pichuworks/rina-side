...
const I18N = {
  ...
  toolSignalOutputDesc: {
    "zh-CN": "输出参考信号，用于调节卡座的录音电平和 BIAS。选择信号类型，点「开始输出」，卡座进入录音状态后观察电平表调节到目标位置。",
    ja: "カセットデッキの録音レベルと BIAS を調整するための基準信号を出力します。信号の種類を選んで「出力開始」を押し、デッキ側のレベルメーターを見ながら調整してください。",
    en: "Output reference signals for adjusting your deck's recording level and bias. Pick a signal type, click Start, then adjust your deck while monitoring its meters.",
  },
